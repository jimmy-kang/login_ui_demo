...
const FormInput = ({
  ...
  return (
    <div className="slm-relative slm-w-full slm-h-full slm-px-3 slm-py-1 slm-bg-blue-light slm-rounded slm-leading-none slm-gap-0.5">
      <label className="slm-text-xs slm-text-gray-base slm-w-full slm-flex font__base">
        {title}
      </label>
      <input
